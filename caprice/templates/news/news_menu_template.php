...
$NEWS_MENU_TEMPLATE['latest']['item']        = '<li><a class="e-menu-link newsmonths" href="{NEWSURL}">{NEWSTITLE} latest tpl<span class="badge">{NEWSCOMMENTCOUNT}</span></a></li>';
...
$NEWS_MENU_TEMPLATE['other2']['item'] 	= "<li class='media'>
										...
										<div class='media-body'><h4>{NEWSTITLELINK} other2 tpl</h4>
...
$NEWS_MENU_TEMPLATE['grid']['item']		= '<div class="item {NEWSGRID}">
												...
												{NEWSTHUMBNAIL=placeholder}
              									<h3>{NEWSTITLE: limit=_titleLimit_} Grid item</h3>
